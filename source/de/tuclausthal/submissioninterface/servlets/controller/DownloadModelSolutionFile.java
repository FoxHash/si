/*
 * Copyright 2010-2012, 2014 Sven Strickroth <email@cs-ware.de>
 * 
...
public class DownloadModelSolutionFile extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (participation == null || participation.getRoleType() != ParticipationRole.ADVISOR && participation.getRoleType() != ParticipationRole.TUTOR) { // TODO: Maybe allow pupils to see model-solutions after the deadline?!
